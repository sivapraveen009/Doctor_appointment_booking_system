	...
	if(isset($_POST['APPOINTMENT_DATE']))
		{
			...
			$foo=$_SESSION['APPOINT_ID'];
			$q="SELECT CURRENT_DATE()";
			$s=mysqli_query($connect,$q);
			$fu=mysqli_fetch_all($s,MYSQLI_ASSOC);
			$date=$fu['0']['CURRENT_DATE()'];
			...
			{
			$update="UPDATE APPOINTMENT SET DOC_ID='$doc_id' WHERE APPOINT_ID='$foo'";
			mysqli_query($connect,$update);
			$update1="UPDATE APPOINTMENT SET APPOINTMENT_DATE='$appointment_date' WHERE APPOINT_ID='$foo' AND APPOINTMENT_DATE>'$date' ";
