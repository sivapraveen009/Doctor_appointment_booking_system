...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div style="margin-top: 15px;margin-bottom: -5px;">
    	...
    	<div class="row">
    		    <div  style="width:35%;padding: none;overflow: none;"><p style="color:red;">*Invalid email-id or password</p></div>
    		    <div class="col"><a href="" type="submit" data-toggle="modal" data-target="#myModal2" >forget password?</a></div>
    	</div>
